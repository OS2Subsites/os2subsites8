...
$config['bc_subsites.settings'] = [
  ...
  'default_profile' => empty(getenv('DEFAULT_PROFILE')) ? 'minimal' : getenv('DEFAULT_PROFILE'),
];

if (getenv('BASE_SUBSITE_CONFIG_DIR')) {
  $config['bc_subsites.settings']['base_subsite_config_dir'] = getenv('PROFILE');
}
